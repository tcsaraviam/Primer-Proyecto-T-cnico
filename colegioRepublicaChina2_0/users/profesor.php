...
<?php
    ...
    if(!isset($_SESSION['usuario'])){
        ...
        while($cconsulta = mysqli_fetch_array($rresultados)){
            ...
            if($rolesito == 1){
                $saludo = 'Bienvenido administrador@ '. $name_kudasai;
            }else if($rolesito == 2){
                $saludo = 'Bienvenido programador@ '. $name_kudasai;
            }else if($rolesito == 3){
                $saludo = 'Bienvenido profesor@ '. $name_kudasai;
            }else if($rolesito == 4){
                echo '
                <script>
                alert("Debes ser profesor para ingresar ;)")
...
<head>
  ...
  <!--titulo-->
  <title>República de China | Profesor</title>
            ...
            <div class="contenedor_all" id="contenedor_all">                
                <div class="contenedor-users">
                    ...
                    <div class="contenedor-users_acciones">
                        <div class="acciones">
                            <p>Agregar, modificar eliminar y analizar notas de los alumnos </p>
                            <div>
                                <button class="learn-more" onclick='location.href="crudbasic/alumnosTabla.php"'>
