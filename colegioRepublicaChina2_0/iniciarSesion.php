    ...
    if(!isset($_SESSION['usuario'])){
        ...
        while($cconsulta = mysqli_fetch_array($rresultados)){
            ...
            if($rolesito == 1){
                echo '
                <script>
                alert("Debes ser programador para ingresar ;)")
                window.location = "admin.php";
                </script>
            ';
            }else if($rolesito == 2){
                $saludo = 'Bienvenido programador@ '. $name_kudasai;
            }else if($rolesito == 3){
                echo '
                <script>
                alert("Debes ser programador para ingresar ;)")
...
<head>
  ...
  <!--titulo-->
  <title>República de China | Programador</title>
            ...
            <div class="caja_trasera">
                ...
                <div class="contenedor_login-register">
                    ...
                    <form action="registro_usuario_be.php" method="POST" class="formulario_register"> <!--REGISTER-->
                        ...
                        <h2>Registrarse</h2>
                        <input type="text" placeholder="Nombre Completo"    name="nombre_completo" required autocomplete="off">
                        <input type="email" placeholder="Correo Electronico"name="correo" required autocomplete="off">
                        ...
                        <input type="text" placeholder="Rol"                name="id_rol" required autocomplete="off">
